...
def main():
    ...
    while True:
        ...
        cv.moveWindow('edges0', 60, 980)
        cv.namedWindow('edges1')
        cv.moveWindow('edges1', 460, 980)
        cv.namedWindow('edges2') 
        cv.moveWindow('edges2', 860, 980)
        cv.namedWindow('edges3')
        cv.moveWindow('edges3', 1260, 980)
